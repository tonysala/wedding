...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var timer = function timer() {
    ...
    var seconds = Math.floor(diff % (1000 * 60) / 1000); // Adding the zeros.

    days <= 99 ? days = "0".concat(days) : days;
    days <= 9 ? days = "00".concat(days) : days;
  ...
  var stripe = Stripe('pk_live_51IN4zeEsMnHooy9laxk40JxfAoD02skA8fHzPCR3ej9XvRidoZiHUJfS6oz81AgfLF3yIuC7noAQeV486puGwuKV00gsgioeaz');
  var donate_button = document.getElementById('donate');
